...
- **Lunghezza richiesta (in numero di parole)**: il numero (o intervallo) indicato dall'utente a inizio flusso. È il valore **prioritario** che determina lunghezza e struttura del pezzo, e prevale sulla media del portale. Solo se l'utente non l'ha specificata e ha scelto "basati sul portale" si usa la media dei guest post rilevata dalla host-site-analysis; in mancanza anche di quella, default 500‑900 parole.
...
**Rispettare la lunghezza richiesta.** Il pezzo deve avvicinarsi al **numero di parole indicato dall'utente** (o rientrare nell'intervallo indicato). È il vincolo prioritario e prevale sulla media del portale. Dentro quel budget, non gonfiare e non tagliare a metà: costruisci una struttura che *quella* lunghezza la riempie in modo naturale (un pezzo da 500 parole ha meno sezioni di uno da 1200). Solo se l'utente non ha indicato una lunghezza e ha scelto "basati sul portale" usa la media dei guest post della host-site-analysis; in mancanza anche di quella, default 500‑900 parole.

**Struttura variabile e creativa (non un template).** La struttura va **costruita sul topic, sull'angolo e sulla lunghezza richiesta**, non calata da uno schema fisso. Evita di produrre sempre lo stesso scheletro (intro + N sezioni uguali + conclusione). Varia, articolo per articolo: il numero e la profondità degli H2/H3, la presenza o meno di H3, il tipo di attacco (aneddoto, domanda, dato, scenario, definizione), la forma (guida, approfondimento narrativo, taglio comparativo, caso pratico, panoramica), il ritmo. Due articoli diversi non devono somigliarsi strutturalmente. Mantieni comunque un impianto leggibile: introduzione, sviluppo per H2 (con H3 dove servono), chiusura naturale; paragrafi brevi; ed esempi d'uso realistici, casi pratici o spiegazioni comparative dove aiutano il lettore.
...
- La lunghezza dell'articolo segue il numero di parole indicato dall'utente (priorità assoluta); la media del portale è solo fallback se l'utente ha scelto "basati sul portale", altrimenti default 500‑900 parole.
