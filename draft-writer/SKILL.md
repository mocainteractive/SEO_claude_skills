...
- **Vietato usare "Conclusione" (e sinonimi) come titolo dell'H2 finale**: mai heading come "Conclusione", "Conclusioni", "In sintesi", "Per concludere", "Considerazioni finali", "Tirando le somme", "In definitiva", "Ultima parola" o simili. Se il brief propone questi titoli, riscrivili in forma utile alla SEO (rifocalizzando keyword primaria o angolo del pezzo, es. "Come iniziare oggi con [keyword]") e segnalalo nelle note al revisore. Il paragrafo conclusivo deve esistere e deve essere sostanzioso, ma l'heading non può essere vuoto di significato.
- **URL sempre assoluti** quando inserisci un link nel testo o quando lo riporti nelle note al revisore: sempre `https://dominio.tld/percorso-completo`, mai il solo path relativo (`/blog/…`). Anche nel corpo dell'articolo l'attributo `href` deve puntare all'URL assoluto quando il brief lo fornisce assoluto.
- **Ogni link nel testo deve avere l'anchor prevista dal brief**: mai omettere l'anchor né sostituirla con "clicca qui" / "leggi qui" / "scopri di più" / "visita il sito" / "leggi la nostra guida". Se l'anchor esatta del brief non scorre nel contesto specifico, trova la variante più vicina che mantiene la parola-chiave semantica.
